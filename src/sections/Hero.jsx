...
const Hero = () => {
  ...
  return (
    <section
      ...
      <div className="relative flex flex-1 justify-center items-center xl:min-h-screen max-xl:pt-20 max-xl:pb-60 bg-primary bg-hero bg-cover bg-center">
        <img 
          src={bigShoeImg}
          width={610}
          height={500}
      ...
      <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6 mb-14">
